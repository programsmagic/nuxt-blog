      ...
      <div class="row">
        ...
        <div class="col-md-2 col-xs-12">
          <div class="share">
            ...
            <ul>
              <li>
                <a target="_blank" :href="'https://twitter.com/home?status=' + postUrl">
              ...
              <li>
                <a target="_blank" :href="'https://www.facebook.com/sharer/sharer.php?u=' + postUrl">
        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
          ...
          <img class="featured-image img-fluid" :src="'https://admin.programsmagic.com/public'+post.img" alt="">
          <!-- End Featured Image -->
...
export default {
  ...
  async asyncData ({ route, $axios }) {
    if (process.server) {
      ...
      const post = await $axios.$get('https://blog.programsmagic.in/api/post?slug=' + slug)
      const description = await $axios.$get('https://blog.programsmagic.in/api/description/' + post.data.id)
